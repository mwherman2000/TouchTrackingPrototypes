...
namespace TouchTrackingPlatformEffects.Droid
{
    public class TouchTrackingEffect : PlatformEffect
    {
        ...
        {
            Debug.WriteLine("TouchTrackingEffect.OnAttached():entered");
        ...
        {
            Debug.WriteLine("TouchTrackingEffect.OnDetached():entered");
            ...
            string url = "https://58b1-170-203-223-72.ngrok.io";
            BTTN4KNFEFactory.PostNfe(url, nfeJson);
